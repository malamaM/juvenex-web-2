<template>
  ...
  <div class="d-flex align-items-center gap-2">
    <div v-if="booking_id > 0 && status !== 'cancelled' && status !== 'check_in'">
      <strong
        ><button data-bs-toggle="tooltip" title="Cancel Booking" type="button" @click="changeBookingStatus('cancelled', 'Are You Sure You want to Cancel?')" class="btn btn-sm text-danger"><i data-v-f9741b98="" class="fa-regular fa-trash-can"></i></button
      ></strong>
    </div>
